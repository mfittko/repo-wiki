...
- Imports from local module: `./prompts.js` — likely provides prompt templates or utilities for LLM requests.
...
- Details on the internal implementation of key functions and classes (e.g., how requests are built or how errors are handled) are not documented here.
- The exact role and structure of `ArchitecturePageBudget` and how it integrates with the rest of the system remain unspecified.
