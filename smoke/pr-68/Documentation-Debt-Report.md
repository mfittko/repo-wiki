...
|---|---|---:|---:|---:|---:|---:|
| `.github/agents/coordinator.agent.md` | unvalidated | secondary | 2 | 0 | 0 | 0 |
| `.github/agents/developer.agent.md` | unvalidated | secondary | 2 | 0 | 0 | 0 |
| `.github/agents/docs.agent.md` | unvalidated | secondary | 2 | 0 | 0 | 0 |
| `.github/agents/fixer.agent.md` | unvalidated | secondary | 0 | 0 | 0 | 0 |
| `.github/agents/quality.agent.md` | unvalidated | secondary | 2 | 0 | 0 | 0 |
| `.github/agents/review.agent.md` | unvalidated | secondary | 0 | 0 | 0 | 1 |
| `.github/copilot-review-instructions.md` | unvalidated | secondary | 3 | 0 | 0 | 0 |
| `.github/pull_request_template.md` | unvalidated | secondary | 3 | 0 | 0 | 0 |
| `docs/PLAN.md` | partially_validated | secondary | 0 | 9 | 11 | 2 |
| `docs/plans/agent-integration.md` | unvalidated | secondary | 2 | 0 | 0 | 0 |
| `docs/plans/ci-publishing.md` | partially_validated | secondary | 2 | 1 | 0 | 0 |
| `docs/plans/doc-validation.md` | unvalidated | secondary | 2 | 0 | 0 | 0 |
| `docs/plans/incremental-mode.md` | stale | secondary | 0 | 1 | 0 | 0 |
| `docs/plans/llm-compiler.md` | partially_validated | secondary | 0 | 2 | 0 | 8 |
| `docs/plans/production-scanner.md` | unvalidated | secondary | 2 | 0 | 0 | 0 |
| `docs/plans/wiki-graph.md` | unvalidated | secondary | 2 | 1 | 0 | 0 |
| `docs/WHY.md` | partially_validated | secondary | 1 | 5 | 0 | 0 |
