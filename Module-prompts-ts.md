...
These symbols represent the core API of the module, with prompt-building functions serving as entry points for generating prompts in various contexts, and the types providing structured data models and contextual information.
...
- The absence of related tests or documentation leaves open questions about usage examples, expected inputs, and outputs.
