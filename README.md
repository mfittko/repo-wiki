...
GitHub Wiki target defaults to rendering frontmatter as a visible provenance block; GitHub Pages defaults to preserving frontmatter. You can override with `--frontmatter-policy`.
